...
class OrderRepositoryTest {
    ...
    void setUp() {
        ...
        Order order1 = new Order("13652556-012a-4c07-b546-5e4b139d679b", products,1708550000L,"Safira Sudrajat");
        orders.add(order1);
        Order order2 = new Order("7f9e15bb-4b15-42f4-aebc-ca3f385fb078", products, 1708550000L,"Safira Sudrajat");
        orders.add(order2);
        Order order3 = new Order("e334ef40-9eff-4da8-9487-8ee679ecbf1e", products, 1708550000L,"Bambang Sudrajat");
        orders.add(order3);
    }
    ...
    void testFindByIdIfIdNotFound() {
        ...
        Order findResult = orderRepository.findById("zzc2c");
